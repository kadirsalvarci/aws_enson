...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///./users.db' #zorunlu eklememiz gerekir 
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False #buna gerek yok false demessek bu takip eder ve yer kaplar bize lazim deil 
db = SQLAlchemy(app)

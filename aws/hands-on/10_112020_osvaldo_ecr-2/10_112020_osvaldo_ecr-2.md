...
aa1997fbc3c855f017bb00c01cf6fe430ff3362f
Add "token" after "//" in the "url" part . And also paste "@" at the and of the token.
  "url = https://aa1997fbc3c855f017bb00c01cf6fe430ff3362f@github.com/awsdevopsteam/todo-app-node-project.git
...
```bash
docker run --name todo -dp 80:3000 644123363827.dkr.ecr.us-east-1.amazonaws.com/clarusway-repo/todo-app:latest
```
...
```groovy
  pipeline {
    agent { label "master" }
    environment {
        ECR_REGISTRY = "644123363827.ecr.us-east-1.amazonaws.com"
        APP_REPO_NAME= "clarusway-repo/todo-app"
    }
    stages {
        stage('Build Docker Image') {
